...
namespace Commandor
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //GunsFactory gunsfactory = new GunsFactory();
            //commandofactory.CommandoFactorMethod();
            //enemyfactory.EnemyFactoryMethod();
            //gunsfactory.GunsFactoryMethod();


            //foreach (Commando item in commandofactory.commandos)
            //{
